...
void raw_api_init(const raw_api_config_t *cfg) {
     ...
     * Config: cipher 0=aes128cfb 1=aes128cbc 2=xor 3=none
     * udp2raw: cipher_none=0 cipher_aes128cbc=1 cipher_xor=2 cipher_aes128cfb=3 */
    static const cipher_mode_t cipher_map[] = {cipher_aes128cfb, cipher_aes128cbc, cipher_xor, cipher_none};
    cipher_mode = (cfg->cipher_mode >= 0 && cfg->cipher_mode < 4) ? cipher_map[cfg->cipher_mode] : cipher_aes128cbc;
